...
def derefine(vor, gas, minvol=-1):
    ...
    distr = partial(distribute, gas["Density"], gas["Masses"]/gas["Density"], gas["InternalEnergy"], gas["Velocities"], binsx, binsy, binsz, grid_size)
    ...
    np.save('refined_dens.npy', derefined_mass)
    np.save('refined_vels.npy', derefined_momentum)
    np.save('refined_energy.npy', derefined_energy)
...
derefine(vor_with_mirr, galaxy.gas)